...
function WalletConnectSection() {
  ...
  return (
    <>
      <div style={{ background: '#ffff00', border: '2px solid #ff8800', padding: '8px', fontSize: '11px', textAlign: 'center', marginBottom: '8px' }}>
        ⚠️ Connect your wallet to pay your share
      </div>
      <button 
